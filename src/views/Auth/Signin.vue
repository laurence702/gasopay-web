              ...
              <div>
                ...
                <div class="mt-5">
                  <a
                    ...
                    class="flex items-center justify-center w-full gap-2 py-3 border border-gray-200 rounded-lg dark:border-gray-800"
                  >
...
const handleSubmit = async () => {
  ...
  try {
    ...
    // Redirect to a neutral path and let the navigation guard handle role-based routing.
    await router.push('/');
  } catch (error: unknown) {
